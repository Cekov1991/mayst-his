<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Create Spectacle Prescription - {{ $visit->patient->full_name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8">
                    ...
                    <!-- Spectacle Form -->
                    <form action="{{ route('visits.spectacles.store', $visit) }}" method="POST" class="space-y-8"
                          x-data="{ type: '{{ old('type', 'distance') }}' }">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="type" id="type" x-model="type" required
                                    ...
                                    <option value="near" {{ old('type') === 'near' ? 'selected' : '' }}>Near</option>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900/20 p-6 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div x-show="type === 'bifocal' || type === 'progressive'">
                                    ...
                                    <input type="number" step="0.25" name="od_add" id="od_add" value="{{ old('od_add') }}"
                                           class="mt-1 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-white/5 dark:text-white dark:ring-white/10 dark:placeholder:text-gray-500 dark:focus:ring-indigo-500"
                                           placeholder="0.00">
                                    @error('od_add')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-900/20 p-6 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div x-show="type === 'bifocal' || type === 'progressive'">
                                    ...
                                    <input type="number" step="0.25" name="os_add" id="os_add" value="{{ old('os_add') }}"
                                           class="mt-1 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-white/5 dark:text-white dark:ring-white/10 dark:placeholder:text-gray-500 dark:focus:ring-indigo-500"
                                           placeholder="0.00">
                                    @error('os_add')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
