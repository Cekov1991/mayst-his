            ...
            <div class="px-4 sm:px-6 lg:px-8">
                ...
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold text-gray-900 dark:text-white">{{ his_trans('visits.title') }}</h1>
                ...
                <div class="mt-6">
                    <form method="GET" action="{{ route('visits.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                        <div>
                            <label for="search" class="block text-sm font-medium text-gray-900 dark:text-white">Search</label>
                            <input type="text"
                                   id="search"
                                   name="search"
                ...
                <x-table>
                    <x-slot name="head">
                        ...
                        <x-table-header-secondary>Doctor</x-table-header-secondary>
                    ...
                    <x-slot name="body">
                        ...
                        @empty
                            <x-table-empty
                                ...
                                action-text="{{ his_trans('visits.add_visit') }}"
                            />
                        @endforelse
                    </x-slot>
                </x-table>
